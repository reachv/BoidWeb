    ...
    return (
        <>
          <Row>
            <Col xs={4}/>
            <Col xs={8}>
              <Row><Typography variant="h2" style={{paddingTop:"1em", paddingBottom:"1em"}}>{TEXT_CONFIG.EDGE_CONTENT.TITLE}</Typography></Row>
              <Row><Typography variant="body1" style={{paddingBottom:"2em"}}>{TEXT_CONFIG.EDGE_CONTENT.BODY[0]}</Typography></Row>
          ...
          <Row style={{paddingTop:"2em"}}>
            <Col xs={4}/>
            <Col xs={8}>
              <Row><Typography variant="body1" style={{ paddingBottom:"2em"}}>{TEXT_CONFIG.EDGE_CONTENT.TRANSITION[0]}</Typography></Row>
